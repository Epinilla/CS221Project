...
while input2 != str(35):
    ...
    df1 = pd.read_csv("dataTuesday250.csv")
    late = 0
    nLate = 0
    ...
    # print ("late", late, "nLate: ", nLate)
        if index % 5 ==0:
            print ("adding point: ", index)
            finstr = "Tuesday{}_{}.csv".format(input1, input2)
            print ("file done:", finstr)
            df1.to_csv(finstr, encoding='utf-8', index = False)
